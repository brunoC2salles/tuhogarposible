        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 bg-muted/50 rounded">
                ...
                <Badge variant={(datos.deudasActuales + resultados.cuotaMensual) / datos.ingresosMensuales * 100 <= 20 ? "default" : "destructive"}>
          ...
          <div className="p-4 bg-muted/30 rounded-lg">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>• Relación cuota/ingreso: <strong>{((datos.deudasActuales + resultados.cuotaMensual) / datos.ingresosMensuales * 100).toFixed(2)}%</strong> {((datos.deudasActuales + resultados.cuotaMensual) / datos.ingresosMensuales * 100) <= 20 ? '✓' : '⚠️'}</li>
              <li>• Regla: cuota ≤ <strong>(ingresos × 20%) − deudas</strong></li>
            </ul>
          </div>
