...
import { Calculator, Home, User, Building2, FileText, Upload, Download, Trash2, Plus, ExternalLink, UserCog, Eye, Pencil, MapPin, Bed, Bath, Maximize2, CheckCircle, AlertTriangle } from 'lucide-react';
